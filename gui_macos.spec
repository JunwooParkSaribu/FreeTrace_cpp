...
a = Analysis(
    ...
    hiddenimports=['PyQt6.sip', 'numpy', 'pandas', 'tifffile', 'nd2', 'matplotlib', 'seaborn', 'scipy', 'scipy.optimize'],  # Modified by Claude (claude-opus-4-6, Anthropic AI) - 2026-03-19
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[
...
app = BUNDLE(
    ...
    info_plist={
        ...
        'CFBundleShortVersionString': '1.6.1.1',  # Modified by Claude (claude-opus-4-6, Anthropic AI) - 2026-03-20
