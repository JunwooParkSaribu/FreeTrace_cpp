...
REM Check deps folder -- Modified by Claude (claude-opus-4-6, Anthropic AI) - 2026-03-15 00:00
...
REM Check default install location -- Modified by Claude (claude-opus-4-6, Anthropic AI) - 2026-03-15 00:00
