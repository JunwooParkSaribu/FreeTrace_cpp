...
python -m pip install pyinstaller PyQt6 scipy numpy pandas tifffile nd2 google-genai --quiet
...
if not defined ISCC_CMD (
    ...
    echo.
    echo Installer created: installer\FreeTrace_1.6.3.0_RTX5000_win64_setup.exe
)
