...
class FreeTraceGUI(QMainWindow):
    ...
    def _build_left_panel(self):
        ...
        adv_grid.addWidget(QLabel("Shift:"), 0, 0)
        self._shift = QSpinBox()
        self._shift.setRange(1, 5)
        self._shift.setValue(1)
        self._shift.setToolTip("Shift parameter for localization.")
        adv_grid.addWidget(self._shift, 0, 1)

        adv_grid.addWidget(QLabel("Graph depth (\u0394t):"), 1, 0)
        ...
        adv_grid.addWidget(self._graph_depth, 1, 1)

        adv_grid.addWidget(QLabel("Jump threshold (0=auto):"), 2, 0)
        ...
        adv_grid.addWidget(self._jump_threshold, 2, 1)
        ...
        adv_grid.addWidget(self._fbm_mode, 3, 0, 1, 2)
        ...
        adv_grid.addWidget(self._postprocess, 4, 0, 1, 2)
    ...
    def _on_run(self):
        ...
        args.extend(["--shift", str(self._shift.value())])
